...
namespace Tassle.Services
{
    ...
    /// </summary>
    public abstract class ServiceControllable : Service, ControllableServiceInterface
    {
        // constructors
        ...
        /// </summary>
        protected ServiceControllable(ILoggerFactory loggerFactory) : base(loggerFactory)
        {
        }
